    ...
    options: {
      ...
      animation: {
        onComplete: function () {
          ...
          document.getElementById('te-result-section').innerHTML = '<img src="Assets/loader.gif" id="processing-image" width="35px" alt=""> We are sending you full report through email! please wait...';
          ...
          let te_dryFoodsOutput = document.getElementById('dryFoodsOutput').innerText;
            ...
            .then(json => {
              console.log(json);
              document.getElementById('te-result-section').innerHTML = '<img src="Assets/done.png" id="processing-image" width="35px" alt=""> Thank you! you will get an email with the full business case report.';
            });      
        },
      },
    },
