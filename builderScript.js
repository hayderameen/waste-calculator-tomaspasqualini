...
<div class="send-report-form" id="te-send-report-form" style="display: none;">
  <div class="div-block-13">
    <h1 id="contactUs" class="heading-3">We will send you the report, prepared especially for you 🚀</h1>
    <div class="text-block-12-te te-mt-30">The business case is calculated based on your actual sales and waste performance, to show you the improvement you can achieve in your stores.</div>
  </div>
  <div class="div-block-14">
    <div class="form-block w-form">
      <form action="#" id="te-send-report-form" onSubmit="return submitCalcForm(event);">
        <div class="te-mt-60 te-mb-30 form-instruction">Please fill out the form:</div>
        <p>
